// lib/clientes/alquiler_screen.dart
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (_, snap) {
        ...
        if (filtered.isEmpty) {
          return const Center(
            child: Text(
                'No hay alquileres', style: TextStyle(color: Colors.white)),
          );
        }
